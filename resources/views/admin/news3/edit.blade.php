                    ...
                    <div class="col-20">
                        <div class="col-20">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" placeholder="title" value="{{$news3->title}}">
                        ...
                        <div class="col-20">
                            <div class="form-group">
                                ...
                                <input type="text" name="about" class="form-control @error('about') is-invalid @enderror" placeholder="about" value="{{$news3->about}}">
                        ...
                        <div class="col-20">
                            <div class="form-group">
                                ...
                                <input type="text" name="client" class="form-control @error('client') is-invalid @enderror" placeholder="client" value="{{$news3->client}}">
